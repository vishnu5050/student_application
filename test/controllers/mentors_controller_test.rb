...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { age: @mentor.age, bio: @mentor.bio, country: @mentor.country, dob: @mentor.dob, gender: @mentor.gender, name: @mentor.name }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { age: @mentor.age, bio: @mentor.bio, country: @mentor.country, dob: @mentor.dob, gender: @mentor.gender, name: @mentor.name }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
